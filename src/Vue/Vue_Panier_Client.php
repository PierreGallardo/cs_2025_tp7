 ...
 <thead >
        ...
        ";
            ...
            foreach ($this->listeProduits as $produit) {
                ...
                $path="/image/" . $produit["fichierImage"];
...
".genereChampHiddenCSRF()."
            ...
            $produit[quantite]   
                ...
                $str .= "<td > ";
                $coutLigneHT=$produit["prixCatalogueHT"] * $produit["quantite"];
                $str .= $coutLigneHT;
                $totalHT += $coutLigneHT;
                ...
                $str .= " %
                    ...
                    <td > ";
                $coutMontantTVA=$coutLigneHT * $produit["tauxTVA"];
                $str .= $coutMontantTVA;
